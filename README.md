...
### Note: Errors in notebook
I am having some problems with getting the banana env to run after the first time it is launched. The errors seen in the notebook are due to that. In the first run, it executed the training and testing both very well.
